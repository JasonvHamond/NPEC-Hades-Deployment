...
def get_innoculation_point(x,y):
...
def run(protocol: protocol_api.ProtocolContext, locations, curr_tip, curr_well):
    """
    """
    ...
    for i, location in enumerate(locations, start=1):
        ...
        coords = get_innoculation_point(location[0], location[1])
